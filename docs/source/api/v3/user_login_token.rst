...
``POST``
========
Authentication of a user using a token. Normally, the token is obtained via a call to either :ref:`to-api-v3-user-reset_password` or :ref:`to-api-v3-users-register`.
