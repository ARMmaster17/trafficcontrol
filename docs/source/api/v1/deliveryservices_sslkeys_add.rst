...
.. _to-api-v1-deliveryservices-sslkeys-add:

********************************
``deliveryservices/sslkeys/add``
********************************

.. seealso:: In most cases it is preferable to allow Traffic Ops to generate the keys via :ref:`to-api-v1-deliveryservices-sslkeys-generate`, rather than uploading them manually using this endpoint.
