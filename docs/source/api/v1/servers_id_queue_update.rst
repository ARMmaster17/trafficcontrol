...
.. _to-api-v1-servers-id-queue_update:

*******************************
``servers/{{ID}}/queue_update``
*******************************
.. caution:: In the vast majority of cases, it is advisable that the ``PUT`` method of the :ref:`to-api-v1-servers-id` endpoint be used instead.
